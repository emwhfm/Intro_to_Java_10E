...
public class ParallelMatrixMultiplication {
    ...
    private static double[][] sequentialMulMatrix(double[][] a, double[][] b) {
    ...
    private static double[][] parallelMulMatrix(double[][] a, double[][] b) {
        double[][] c = new double[SIZE][SIZE]; 
        RecursiveAction mainTask = new MulTask(a, b, c, 0, SIZE - 1, 0, SIZE - 1);
    ...
    private static class MulTask extends RecursiveAction {
        ...
        MulTask(double[][] a, double[][] b, double[][] c, 
        ...
        protected void compute() {
            if (stop_row - start_row < THRESHOLD) {
                ...
                invokeAll(new MulTask(a, b, c, start_row, mid_row, start_col, stop_col),
                        new MulTask(a, b, c, mid_row + 1, stop_row, start_col, stop_col));
            }
        }
